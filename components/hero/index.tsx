  ...
  return (
    <div>
      <div className="relative h-screen">
        ...
        <div 
          className="absolute top-0 left-0 w-full h-full bg-black opacity-50"></div>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          ...
          <motion.div
            ...
            viewport={{ once: true}}
          >
          <Button variant="outline" className="text-white border-indigo-600 border-2 bg-indigo-600 hover:bg-transparent hover:text-white hover:border-white">
            See our services
          </Button>
          </motion.div>
        </div>
