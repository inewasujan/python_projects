  ...
  return (
    <section>
      <div className="">
        ...
        {/* <h2 className="text-4xl font-bold text-gray-900 lg:text-left text-center">Testimonials  </h2> */}
        {/* Slider controls  */}
        {/* <div className="flex items-center lg:justify-start justify-center gap-4">
          <button id="slider-button-left" className="slider-button group flex justify-center items-center border border-solid border-indigo-600 w-12 h-12 transition-all duration-500 rounded-full hover:bg-indigo-600 " data-carousel-prev>
          ...
          <button id="slider-button-right" className="slider-button group flex justify-center items-center border border-solid border-indigo-600 w-12 h-12 transition-all duration-500 rounded-full hover:bg-indigo-600" data-carousel-next>
              <svg className="h-6 w-6 text-indigo-600 group-hover:text-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        >
          <motion.div 
            className="group bg-white border border-solid border-gray-300 rounded-2xl p-6 transition-all duration-500 w-full max-w-md hover:border-indigo-600 mx-auto md:mr-0"
            variants={fadeInUp}
          initial="initial"
          whileInView="animate"
          viewport={{ once: true }}
          ...
          <motion.div 
            className="group bg-white border border-solid border-gray-300 rounded-2xl p-6 transition-all duration-500 w-full max-w-md hover:border-indigo-600 mx-auto md:ml-0 max-md:hidden"
            variants={fadeInUp}
            initial="initial"
            whileInView="animate"
            viewport={{ once: true }}
          ...
          <motion.div 
            className="group bg-white border border-solid border-gray-300 rounded-2xl p-6 transition-all duration-500 w-full max-w-md hover:border-indigo-600 md:col-span-2 mx-auto max-lg:hidden "
            variants={fadeInUp}
            initial="initial"
            whileInView="animate"
            viewport={{ once: true }}
