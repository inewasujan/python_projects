      ...
      ></div>
        <div className="container mx-auto flex flex-col lg:flex-row sm:flex-col xs:flex-col pb-40 gap-8 lg:gap-32 sm:gap-5 xs:gap-3">
          ...
          >
            ...
            <p className="mt-8">We are team of professional cleaner with more than 10 years of experience.</p>
          </motion.div>
          <div className="text-lg leading-8 tracking-normal text-justify w-full">
            ...
            <div className="mb-8">
                <input type="subject" name="inquiry" className="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-3.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Inquiry of services" required />
            </div>
            <div className="mb-8">
                <textarea name="message" className="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-3.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Hi there, I am interested in your ..." required />
            </div>
